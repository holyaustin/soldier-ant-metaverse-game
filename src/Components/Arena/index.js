    ...
    const onAttackComplete = (newBossHp, newPlayerHp) => {
        ...
        */
        ...
        if (playerHp === 0) {
          ...
          alert("Game Over... You lost. No food for you and your colony. NFT sent for playing, Check your wallet on Polygon")
          mintReward()
        }
        if (bossHp === 0) {
          console.log('Game Over... You Won');
          alert("Game Over... You Won the battle. Enjoy the food with your colony. NFT sent for playing, Check your wallet on Polygon")
          mintReward()
        }
    };
